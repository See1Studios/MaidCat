...
- unreal.get_editor_subsystem(unreal.EditorUtilitySubsystem).function_name → util_sys.function_name
...
def can_run(asset: unreal.Object) -> bool:
    """에셋을 실행할 수 있는지 확인합니다."""
    subsystem : unreal.EditorUtilitySubsystem = _get_editor_utility_subsystem()
