import unreal
OWNER =  unreal.Name("TAPark")

#MENU NAME
ASSETEDITOR_TOOLBAR_COMMON = unreal.Name("AssetEditorToolBar.CommonActions")
...
ICONS_WORLD = unreal.Name("Icons.World")
ICONS_WORLD2 = unreal.Name("SceneOutliner.World")